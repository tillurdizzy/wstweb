...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'admin/unit-search', component: UnitSearchComponent, canActivate: [authGuard, AdminGuard] },
      { path: 'admin/parking', component: ParkingComponent, canActivate: [authGuard, AdminGuard] },
